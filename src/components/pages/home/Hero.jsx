...
const Hero = () => {
  return (
    <>
      ...
      >
        <div className="  flex space-x-2.5 bg-white-99 items-center p-3.5 rounded-lg lp:py-3 lp:px-6">
          <div className="bg-primary-95 p-3 flex items-center w-12 h-12 rounded-md">
        ...
        <div className="flex gap-2 text-normal justify-center mt-[50px] md:gap-3">
          ...
          <button className="bg-white py-3.5 px-5 text-grey-15 rounded-md">
            View Pricing
          </button>
        </div>
      </section>
